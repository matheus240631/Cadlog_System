...
<option value="<?= $user['perfil']  == 'admin' ? 'selcted' : '' ?>">Admin</option>
<option value="<?= $user['perfil']  == 'gestor' ? 'selcted' : '' ?>" >Gestor</option>
<option value="<?= $user['perfil'] == 'colaborador' ? 'selcted' : ''?>" >Colaborador</option>
</select>
